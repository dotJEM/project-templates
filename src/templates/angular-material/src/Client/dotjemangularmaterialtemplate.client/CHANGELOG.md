...
- Create Angular project with ng: `ng new dotjemangularmaterialtemplate.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`dotjemangularmaterialtemplate.client.esproj`).
